<template> 
    <div>
        ...
        <header class="sticky top-0 z-50 flex justify-between items-enter space-x-1 border-b bg-white p-4 shadow-md dark:bg-black">
            ...
            <NuxtLink :to="{name:'dark-mode'}" class="text-2xl font-momo dark:text-white dark:hover:text-blue-800"> Dark Mode </NuxtLink> 
            ...
            <NuxtLink :to="{name:'fetching-data'}" class="text-2xl font-momo dark:text-white dark:hover:text-blue-800"> Fetching Data </NuxtLink>  
